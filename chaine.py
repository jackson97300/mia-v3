...
----------------------------------------
`L0_POSITION_OUVERTE` ferme 93,5 % des signaux sur ES. La bloquer ne suffit
...
def etat_neuf():
    ...
    return {"n_jour": 0, "pnl_jour": 0.0, "fin_cooldown": -1,
            "libre_a": -1, "side_ouvert": 0, "i_entree": -1,
            "issue_ouverte": None}
