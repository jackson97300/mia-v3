...
|---|---|---|---|
| 1. couverture des canoniques (scénario final EN COURS, pré-enregistrée) | 60 % (45-80) | **93 %** | TROP LARGE (> 80 %) |
| 1 bis. couverture des canoniques VALIDÉS à la clôture | — | **58 %** | dans l'attendu (à la relectrice de dire laquelle est la couverture) |
| 2. validés à 10h30 encore vrais à 16h00 | 55 % (≥ 40) | **60 %** (N validés à 10h30 = 5) | ATTENDU |
| 2 bis. en cours à 10h30 encore en cours à 16h00 (large) | — | 67 % (N = 54) | description |
| 3. contrôle négatif, couverture : tirage moyen / p95 | grammaire − p95 ≥ 15 pts | 16 / 25 % → écart **+68** | BAT LE TIRAGE |
| 3. contrôle négatif, tenue : tirage moyen / p95 | idem | 6 / 20 % → écart +40 | |
...
| S_OUV_BAS_TEND | 14 | 8 | 0.3 | 11h45 |
| S_DANS_CASSURE_BAS | 6 | 2 | 1.7 | 14h00 |
| S_AUTRE | 4 | 0 | 1.0 | 11h00 |
| S_OUV_HAUT_REJET [TRAV] | 4 | 4 | 1.5 | 10h30 |
| S_DANS_POSE | 4 | 4 | 0.0 | 15h45 |
| S_DANS_CASSURE_HAUT | 3 | 0 | 1.0 | — |
| S_OUV_BAS_REINT | 2 | 0 | 3.0 | — |
| S_DANS_HEADFAKE | 2 | 2 | 2.0 | 12h15 |
| S_OUV_BAS_REINT_PULL [PULL] | 1 | 1 | 2.0 | 11h15 |
| S_OUV_HAUT_REJET | 1 | 1 | 5.0 | 11h00 |
...
Bascules par journée : moyenne 0.88, max 5
...
| 20260625 | au_dessus | TEST_DRIVE | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET [TRAV] (oui) | 1 | 10h15 |
| 20260626 | sous | ENCHERE | S_OUV_BAS_REINT (non) | S_OUV_BAS_REINT_PULL [PULL] (oui) | 2 | 11h15 |
| 20260629 | au_dessus | ENCHERE | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_TEND (oui) | 2 | 10h15 |
...
| 20260714 | sous | ENCHERE | S_OUV_BAS_TEND (non) | S_OUV_BAS_REINT (non) | 5 | — |
...
| 20260724 | sous | ENCHERE | S_OUV_BAS_TEND (non) | S_OUV_BAS_TEND (non) | 2 | — |
...
| 20260729 | au_dessus | REJET_RENVERSEMENT | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_TEND (non) | 2 | 09h45 |
...
| 20260812 | au_dessus | TEST_DRIVE | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET [TRAV] (oui) | 1 | 10h30 |
| 20260813 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_TEND (non) | 0 | — |
| 20260814 | au_dessus | ENCHERE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_REJET [TRAV] (oui) | 1 | 11h00 |
...
| 20260820 | sous | TEST_DRIVE | S_OUV_BAS_TEND (non) | S_OUV_BAS_TEND (oui) | 2 | 13h30 |
...
| 20260828 | au_dessus | REJET_RENVERSEMENT | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET [TRAV] (oui) | 3 | 10h15 |
...
| 20260902 | sous | ENCHERE | S_OUV_BAS_REINT (non) | S_OUV_BAS_REINT (non) | 1 | — |
| 20260903 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_TEND (oui) | 0 | 11h15 |
| 20260904 | au_dessus | ENCHERE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_REJET (oui) | 5 | 11h00 |
...
|---|---|---|---|
| 1. couverture des canoniques (scénario final EN COURS, pré-enregistrée) | 60 % (45-80) | **93 %** | TROP LARGE (> 80 %) |
| 1 bis. couverture des canoniques VALIDÉS à la clôture | — | **53 %** | dans l'attendu (à la relectrice de dire laquelle est la couverture) |
| 2. validés à 10h30 encore vrais à 16h00 | 55 % (≥ 40) | **75 %** (N validés à 10h30 = 4) | ATTENDU |
| 2 bis. en cours à 10h30 encore en cours à 16h00 (large) | — | 64 % (N = 53) | description |
| 3. contrôle négatif, couverture : tirage moyen / p95 | grammaire − p95 ≥ 15 pts | 17 / 26 % → écart **+67** | BAT LE TIRAGE |
| 3. contrôle négatif, tenue : tirage moyen / p95 | idem | 9 / 25 % → écart +50 | |
...
| S_AUTRE | 4 | 0 | 0.8 | — |
| S_OUV_HAUT_REJET [PULL] | 2 | 2 | 1.0 | 11h45 |
| S_DANS_POSE | 2 | 2 | 0.0 | 15h45 |
| S_DANS_CASSURE_HAUT | 2 | 0 | 1.0 | — |
| S_OUV_BAS_REINT | 2 | 0 | 4.5 | 11h15 |
| S_OUV_HAUT_REJET [TRAV] | 2 | 2 | 1.0 | 10h30 |
| S_OUV_HAUT_REJET | 1 | 1 | 5.0 | 10h15 |
...
Bascules par journée : moyenne 0.96, max 5
...
| 20260623 | sous | TEST_DRIVE | S_OUV_BAS_TEND (non) | S_OUV_BAS_TEND (non) | 0 | — |
| 20260625 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_REJET [PULL] (oui) | 1 | 11h45 |
...
| 20260702 | sous | TEST_DRIVE | S_OUV_BAS_TEND (non) | S_OUV_BAS_TEND (oui) | 2 | 10h45 |
...
| 20260708 | sous | TEST_DRIVE | S_OUV_BAS_REINT_PULL (non) | S_OUV_BAS_REINT (non) | 4 | 11h15 |
...
| 20260714 | au_dessus | REJET_RENVERSEMENT | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_TEND (oui) | 2 | 10h15 |
| 20260715 | au_dessus | TEST_DRIVE | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET [TRAV] (oui) | 1 | 09h45 |
...
| 20260814 | au_dessus | REJET_RENVERSEMENT | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET [TRAV] (oui) | 1 | 10h30 |
...
| 20260825 | au_dessus | ENCHERE | S_OUV_HAUT_REJET (oui) | S_OUV_HAUT_REJET (oui) | 5 | 10h15 |
...
| 20260902 | sous | ENCHERE | S_OUV_BAS_REINT (non) | S_OUV_BAS_REINT (non) | 5 | — |
| 20260903 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_TEND (oui) | 0 | 11h15 |
| 20260904 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_TEND (non) | 0 | — |
| 20260908 | au_dessus | TEST_DRIVE | S_OUV_HAUT_TEND (non) | S_OUV_HAUT_REJET [PULL] (oui) | 1 | 11h00 |
| 20260909 | sous | ENCHERE | S_OUV_BAS_REINT (non) | S_OUV_BAS_TEND (oui) | 2 | 12h15 |
